...
write.table(train, file = '../data/train.dat', sep = '::', row.names = FALSE,
    col.names = FALSE
)
...
write.table(test, file = '../data/test.csv', sep = ',', row.names = FALSE)
write.table(label, file = '../data/trueLabel.csv', sep = ',', row.names = FALSE)
