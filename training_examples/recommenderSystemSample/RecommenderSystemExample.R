# this is the recommender system examples posted by STAT542 TA
...
setwd("/Users/jinsheng/Documents/UIUC_Course/STAT542/training_examples/recommenderSystemSample")
...
recom
top10 = predict(rec, r[1:nrow(r)], type="topNList", n=10)
top10
